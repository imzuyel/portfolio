...
@section('flow') active @endsection
...
<section class="content">
    ...
    <div class="container-fluid">
        <ol class="breadcrumb breadcrumb-col-pink ">
            <li><a href="{{ route('flow.index') }}"> <i class="material-icons">gamepad</i>Flow</a></li>
        </ol>
        <!-- Exportable Table -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status==1)
                                            <a href="{{ route('flow.unpublished',['id'=>$item->id]) }}"
                                            ...
                                            @else
                                            <a href="{{ route('flow.published',['id'=>$item->id]) }}"
...
@include('backend.flow.create')
@include('backend.flow.edit')
@endsection
@push('js')
