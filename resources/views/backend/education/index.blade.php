...
@section('education') active @endsection
...
<section class="content">
    ...
    <div class="container-fluid">
        <ol class="breadcrumb breadcrumb-col-pink ">
            <li><a href="{{ route('education.index') }}"> <i class="material-icons">library_books</i>Education</a></li>
        </ol>
        <!-- Exportable Table -->
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="header">
                        <h3>Education Control <span><a class="btn bg-success btn-success waves-float" data-toggle="modal"
                                    data-target="#creatEducation">
                                    Add
                                </a></span></h3>
                    </div>
                    <div class="body">
                        <div class="table table-responsive text-center">
                            <table
                                class="table-bordered table-striped table-hover @if(count($educations)>0) dataTable js-exportable @endif">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status==1)
                                            <a href="{{ route('education.unpublished',['id'=>$item->id]) }}"
                                            ...
                                            @else
                                            <a href="{{ route('education.published',['id'=>$item->id]) }}"
                                            ...
                                            <a class="btn bg-success btn-info btn-circle waves-effect waves-circle waves-float"
                                                data-toggle="modal" data-target="#editEducation" data-id="{{ $item->id }}"
...
@include('backend.education.create')
