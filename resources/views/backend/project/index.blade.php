...
<section class="content">
    ...
    <div class="container-fluid">
        <ol class="breadcrumb breadcrumb-col-pink ">
            <li><a href="{{ route('project.index') }}"> <i class="material-icons">done_all</i>Project</a></li>
        </ol>
        <!-- Exportable Table -->
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table  table-responsive text-center">
                            <table
                                class="table-bordered table-striped table-hover @if(count($projects)>0) dataTable js-exportable @endif">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status==1)
                                            <a href="{{ route('project.unpublished',['id'=>$item->id]) }}"
                                            ...
                                            @else
                                            <a href="{{ route('project.published',['id'=>$item->id]) }}"
